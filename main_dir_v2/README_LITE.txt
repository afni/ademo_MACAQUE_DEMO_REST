...
---> NB: this is the "lite" version, with EPI time series truncated to
     the first 75 time points, in order to be a smaller download and
     to run faster when processing.
